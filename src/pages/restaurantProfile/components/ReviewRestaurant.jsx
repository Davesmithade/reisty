...
const ReviewRestaurant = () => {
  return (
    <div className='mb-[50px] leading-[26px] text-[13px]'>
      ...
      <div className='w-full h-auto border border-[#DADADA]  rounded-xl mt-8  flex justify-center items-center flex-col'>
        <div className='h-28 w-full flex justify-start p-2 items-center bg-[#F2F2F2] rounded-t-sm border-[#DADADA] '>
     <TextRating /> 
     <p>77 reviews</p>
        </div>

        <div className='flex justify-center text-center w-full h-80 p-3 rounded-xl lg-max:flex lg-max:flex-col lg-max:justify-center lg-max:items-center lg-max:h-auto'>

        <div className='flex justify-center items-center w-1/2 h-auto rounded-xl m-2 lg-max:w-full border border-[#DADADA] flex-col'>
          <div className='flex h-auto w-full'>
          <div className='w-1/2 flex p-3 items-center'>
            <p className='text-start text-[14px] text-[#2B2B2B]'>Food:</p>
            </div>
            <div className='w-1/2 flex justify-end   p-3 items-center'>
            <p className='text-end text-[#2B2B2B] text-[14px]'>5.0</p>
            </div>
          </div>
          <div className='flex  h-auto w-full'>
            <div className='w-1/2 flex p-3 items-center'>
      ...
      <div className='h-auto w-full flex flex-col justify-center items-center mt-6'>
          ...
          <div className='w-full h-auto border-2 border-[#DADADA] rounded-lg flex justify-center items-center flex-col p-6 m-4 lg-max:h-[400px]'>
            <div className='w-full h-20 rounded-lg flex justify-between items-center lg-max:h-14'>
            ...
            <div className='w-full h-36  rounded-lg mt-3 flex justify-center items-center lg-max:h-60'>
              <p className='p-4 text-[#717171] text-base lg-max:text-[12px]'>
